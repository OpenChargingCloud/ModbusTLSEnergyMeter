...
/**
 * Everything that happened inside this meter.
 *
 ...
 * how often, or with which certificate.
 */
export const logsPage: Page = {
    ...
    render({ root }) {
        ...
        const content = shell(root, {
            active:    '/logs',
            title:     'Logs',
            subtitle:  'Everything that happened inside this meter - refused Modbus requests included.',
